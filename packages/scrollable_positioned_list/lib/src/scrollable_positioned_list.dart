  ...
  Future<void> _startScroll(
    ...
    if (itemPosition != null) {
      ...
      await startingScrollController.animateTo(
          scrollAmount > startingScrollController.position.maxScrollExtent ? startingScrollController.position.maxScrollExtent: scrollAmount,
          duration: duration,
          curve: curve);
    } else {
      ...
      startAnimationCallback = () {
        SchedulerBinding.instance.addPostFrameCallback((_) async {
          ...
          startCompleter.complete(startingScrollController.animateTo(
              startCompleterAmount > startingScrollController.position.maxScrollExtent ? startingScrollController.position.maxScrollExtent: startCompleterAmount,
              duration: duration,
              curve: curve));
          ...
          endCompleter.complete(endingScrollController.animateTo(
              endCompleterAmount > startingScrollController.position.maxScrollExtent ? startingScrollController.position.maxScrollExtent: endCompleterAmount,
              duration: duration,
              curve: curve));
